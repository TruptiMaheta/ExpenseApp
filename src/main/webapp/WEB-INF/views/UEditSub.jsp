	...
	<div class="container">
		<div class="row">
			<div class="col-md-6" style="margin: auto">
				...
				<form action="../updateusubcategory" method="post"
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="payee">Category Name:</label> <input type="text"
								name="cname" value="${user.cname}" Class="form-control" disabled>
						</div>
						
						<div class="form-group">
							<label for="sname"> Sub Category Name:</label> <input type="text"
								Class="form-control" id="sname"
								placeholder="Enter Sub Category Name" name="sname" value="${user.sname}"/>
						</div>
