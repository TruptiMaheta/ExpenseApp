					...
					<fieldset>
						...
						<div class="form-group">
							<label for="exampleInputEmail1" class="form-label"><h5>
									Amount</h5></label> <input type="number" class="form-control" name="ammount">
						...
						<label for="exampleDataList"
							...
							<h5>Account Type</h5></label>
							<select class="form-select glow"
							...
							<div class="col-sm">
								<div class="form-group">
									<label for="subCategory" class="form-label"><h5>SubCategory</h5></label><input
										...
										list="subcategorydatalist" id="subcategoryinput">
						...
						<div class="row">
							<div class="col-sm">
								<div class="form-group">
									<label for="exampleInputEmail1" class="form-label"><h5>
											Description</h5></label> <textarea  class="form-control"
										name="description" id="description"></textarea> <%-- <span><h5>${error}</h5></span> --%>
								</div>
							</div>
							</div>
						<div class="row">
							...
							<div class="col-sm">
								<div class="form-group">
									<label for="inputAddress2" class="form-label"><h5>Current
										...
										class="form-control" name="dateexp">
									<script>
