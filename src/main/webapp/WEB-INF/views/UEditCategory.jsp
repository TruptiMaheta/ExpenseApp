	...
	<div class="container">
		<div class="row">
			<div class="col-md-6" style="margin: auto">
				...
				<form action="../updateucategory" method="post" modelAttribute="user"
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="payee">Payee Name:</label> <input type="text"
								name="pname" value="${user.pname}" Class="form-control"
								disabled>
						</div>
						
						<div class="form-group">
							<label for="cname">Category Name:</label> <input type="text"
								Class="form-control" id="cname" value="${user.cname}"
