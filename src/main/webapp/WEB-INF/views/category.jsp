	...
	<div class="container">
		<div class="row">
			<div class="col-md-6" style="margin: auto">
				...
				<form action="uaddCategory" method="post"
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="pwd">Payee:</label> <select name="id">
								<option>select</option>
								<c:forEach items="${payee}" var="user">
									<option value="${user.pid}">${user.pname}</option>
								</c:forEach>
							</select>
				...
				<tbody>
					<c:forEach items="${category}" var="user">
						<tr>
							<td>${user.cid}</td>
							<td>${user.cname}</td>
							<td><a href="editucategory/${user.cid}"><i class="fas fa-edit"></i></a></td>
							<td><a href="deleteucategory/${user.cid}"><i class="fas fa-trash"></i></a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
