				...
				<form action="addPayee" method="post"
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="pname">Payee Name:</label> <input type="text"
				...
				<tbody>
					<c:forEach items="${payee}" var="user">
						<tr>
							<td>${user.pid}</td>
							<td>${user.pname}</td>
							<td><a href="editpayee/${user.pid}"><i class="fas fa-edit"></i></a></td>
							<td><a href="deletepayee/${user.pid}"><i class="fas fa-trash"></i></a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
